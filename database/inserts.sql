...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Actor` (
  `otraCardinalidad` varchar(50) DEFAULT NULL,
...
INSERT INTO `Actor` VALUES (NULL,1,1),(NULL,2,2),(NULL,3,1),('Uno por área',4,3);
...
CREATE TABLE `Atributo` (
  ...
  `TipoDatoid` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `Atributo` VALUES (1,'Folio','Clave única del evento incendio.',1,10,5,1),(2,'Fecha','Fecha en la que ocurrió el evento.',1,50,5,5);
...
INSERT INTO `CasoUso` VALUES (6,'El actor ACT.Cartógrafo_de_incendios, ACT.Cartógrafo_de_reforestanciones, ACT.Responsable_de_reforestanciones, ACT.Responsable_de_reforestanciones.','ATR.Incendio:Folio, ATR.Incendio:Fecha, ATR.Incendio:Fecha, ATR.Incendio:Fecha, GLS.Área y el GLS.Tipo_de_Evento. ','ATR.Incendio:Folio, ATR.Incendio:Fecha, MSG.1:Operación_exitosa, ATR.Incendio:Fecha, ATR.Incendio:Fecha, GLS.Área y el GLS.Tipo_de_evento.  ','RN.1:Datos_correctos RN.1:Datos_correctos, RN.1:Datos_correctos.',1);
...
INSERT INTO `CasoUso_Actor` VALUES (64,1,6,2),(65,2,6,3),(66,0,6,1);
...
INSERT INTO `CasoUso_ReglaNegocio` VALUES (1,0,6,11);
...
INSERT INTO `Elemento` VALUES (1,'ACT',1,'Cartógrafo de incendios','Personal que se encargará de realizar las georeferencias.',1,1),(2,'ACT',2,'Cartógrafo de reforestanciones','Personal que se encargará de realizar las georeferencias de las reforestaciones.',1,1),(3,'ACT',3,'Responsable de reforestanciones','Personal que se encargará de solicitar el registro de las reforestaciones.',1,1),(4,'ACT',4,'Responsable de indencios','Personal que se encargará de solicitar el registro de los incendios.',1,1),(5,'ENT',1,'Incendio','Un incendio corresponde a un evento.',1,1),(6,'CUSF',0,'Registrar incendios','Este caso uso permite registrar incendios',1,1),(8,'GLS',1,'Tipo de evento','Se refiere a las categorías en las que se dividen los eventos',1,1),(9,'GLS',2,'Área','Se refiere al área que se encarga de antender los eventos ocurridos.',1,1),(10,'MSG',1,'Operación exitosa','Se muestra este mensaje para indicar que la operación se realizó exitosamente.',1,1),(11,'RN',1,'Datos correctos','Esta regla de negocio describe las condiciones necesarias para determinar que un dato es correcto.',1,1);
...
CREATE TABLE `Entidad` (
  ...
  CONSTRAINT `FKEntidad434647` FOREIGN KEY (`Elementoid`) REFERENCES `Elemento` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Entrada` VALUES (51,1,3,6,NULL,8),(52,1,1,6,2,NULL),(53,0,1,6,1,NULL),(54,0,3,6,NULL,9);
...
INSERT INTO `EstadoElemento` VALUES (1,'Edición'),(2,'En Revisión'),(3,'Por liberar'),(4,'Terminado'),(5,'Pendiente de corrección'),(6,'Liberado');
...
INSERT INTO `Mensaje` VALUES (10,'El incendio fue registrado exitosamente.',0);
...
INSERT INTO `Modulo` VALUES (1,'SF','Superficies Forestales','Sistema de Información Geográfica',1);
...
INSERT INTO `Proyecto` VALUES (1,'SIG','Sistema de Información Geográfica','2011-03-12','2012-03-12','2011-03-13','2012-03-13','Sistema para la gestión de áreas naturales protegidas y superficies forestales.',1000,'IPN',1);
...
CREATE TABLE `ReferenciaParametro` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniqueReferencia` (`PostPrecondicionid`,`Pasoid`,`Extensionid`,`PasoidDestino`,`ElementoidDestino`,`AccionidDestino`,`TipoParametroid`,`numeroToken`),
  ...
  CONSTRAINT `FKReferencia384626` FOREIGN KEY (`TipoParametroid`) REFERENCES `TipoParametro` (`id`),
  ...
  CONSTRAINT `FKReferencia742226` FOREIGN KEY (`AccionidDestino`) REFERENCES `Accion` (`id`),
...
INSERT INTO `ReglaNegocio` VALUES (11,'Los datos ingresados en el sistema deberán cumplor con el formato y la longitud definidos en el modelo de datos.',6);
...
INSERT INTO `Salida` VALUES (16,1,3,6,NULL,8,NULL),(17,0,1,6,NULL,NULL,1),(18,0,2,6,10,NULL,NULL),(19,0,3,6,NULL,9,NULL),(20,1,1,6,NULL,NULL,2);
...
INSERT INTO `TerminoGlosario` VALUES (8),(9);
...
INSERT INTO `TipoDato` VALUES (1,'Cadena'),(2,'Flotante'),(3,'Entero'),(4,'Booleano'),(5,'Fecha');
...
INSERT INTO `TipoParametro` VALUES (1,'Atributo'),(2,'Mensaje'),(3,'Termino del glosario'),(4,'Entidad'),(5,'Caso de uso'),(6,'Regla de negocio'),(7,'Actor');
...
INSERT INTO `TipoReglaNegocio` VALUES (1,'Verificación de catálogos'),(2,'Operaciones aritméticas'),(3,'Unicidad de parámetros'),(4,'Datos obligatorios'),(5,'Longitud correcta'),(6,'Tipo de dato correcto'),(7,'Formato de archivos'),(8,'Tamaño de archivos'),(9,'Intervalo de fechas correctas'),(10,'Formato correcto'),(11,'Otro');
...
-- Dump completed on 2015-06-15 19:34:26
