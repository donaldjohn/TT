...
create table Operador (id int(10) not null auto_increment, nombre varchar(45) not null, simbolo int(11) not null, primary key (id), constraint uniqueOperadorSimbolo unique (simbolo), constraint uniqueOperador unique (nombre));
...
create table Atributo (id int(11) not null auto_increment, nombre varchar(45) not null, descripcion varchar(999) not null, obligatorio tinyint(1) not null, longitud int(10), formatoArchivo varchar(10), tamanioArchivo float, UnidadTamanioid int(10), EntidadElementoid int(11) not null, TipoDatoid int(10) not null, primary key (id), constraint uniqueAtributo unique (nombre, EntidadElementoid));
...
alter table ReferenciaParametro add index FKReferencia566006 (Trayectoriaid), add constraint FKReferencia566006 foreign key (Trayectoriaid) references Trayectoria (id);
...
alter table Parametro add index FKParametro572300 (Proyectoid), add constraint FKParametro572300 foreign key (Proyectoid) references Proyecto (id);
alter table Atributo add index FKAtributo234480 (UnidadTamanioid), add constraint FKAtributo234480 foreign key (UnidadTamanioid) references UnidadTamanio (id);
