...
create table Atributo (id int(11) not null auto_increment, nombre varchar(45) not null, descripcion varchar(999) not null, obligatorio tinyint(1) not null, longitud int(10) not null, EntidadElementoid int(11) not null, TipoDatoid int(10), primary key (id), constraint uniqueAtributo unique (nombre, EntidadElementoid));
...
alter table Elemento add index FKElemento396646 (), add constraint FKElemento396646 foreign key () references ReferenciaParametro ();
