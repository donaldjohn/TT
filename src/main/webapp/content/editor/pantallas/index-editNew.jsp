...
<body>
	...
	<s:form autocomplete="off" id="frmPantalla" theme="simple" enctype="multipart/form-data"
		...
		<div class="formulario">
			...
			<div class="seccion">
				...
				<div align="center">
					<sj:a openDialog="accionDialog" button="true">Registrar</sj:a>
				</div>
			</div>
		</div>
	...
	<sj:dialog id="accionDialog" title="Registrar Acción" autoOpen="false"
		...
		<s:form autocomplete="off" id="frmAccion" name="frmAccionName" theme="simple">
			<div class="formulario">
				<div class="tituloFormulario">Información de la Acción</div>
				<table class="seccion">
					<tr>
						<td class="label obligatorio"><s:text name="labelNombre" /></td>
						<td><s:textfield name="accion.nombre" id="accion.nombre" cssClass="inputFormulario ui-widget"
								maxlength="200" cssErrorClass="input-error"></s:textfield></td>
					</tr>
					<tr>
						<td class="label obligatorio"><s:text name="labelDescripcion" /></td>
						<td><s:textarea rows="5" name="accion.descripcion" id="accion.descripcion"
			...
			<br />
			<div align="center">
				<input type="button" onclick="registrarAccion()" value="Aceptar" /> <input
					type="button" onclick="cancelarRegistrarAccion()" value="Cancelar" />
			</div>
		</s:form>
	</sj:dialog>
