...
/**
 * TerminoGlosarioId generated by hbm2java
 */
@Embeddable
public class TerminoGlosarioId implements java.io.Serializable {

	private String elementoclave;
	private int elementonumero;
	private String elementonombre;

	public TerminoGlosarioId() {
	}

	public TerminoGlosarioId(String elementoclave, int elementonumero,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TerminoGlosarioId))
			return false;
		TerminoGlosarioId castOther = (TerminoGlosarioId) other;
