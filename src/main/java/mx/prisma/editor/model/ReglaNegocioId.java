...
/**
 * ReglaNegocioId generated by hbm2java
 */
@Embeddable
public class ReglaNegocioId implements java.io.Serializable {

	private String elementoclave;
	private int elementonumero;
	private String elementonombre;

	public ReglaNegocioId() {
	}

	public ReglaNegocioId(String elementoclave, int elementonumero,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReglaNegocioId))
			return false;
		ReglaNegocioId castOther = (ReglaNegocioId) other;
