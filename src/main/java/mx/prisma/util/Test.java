...
//-------------------------------------------------------------------
	...
	public static void pruebaRegistroProyecto() {
		...
		Colaborador colaborador = new ColaboradorDAO().consultarColaborador("RACS930702HMCMMR05");
		...
		ColaboradorProyecto colaboradorProyecto = new ColaboradorProyecto(colaborador, rol, proyecto);
...
//-------------------------------------------------------------------
	...
	public static void pruebaRegistroActor() {
		...
		Actor actor = new Actor(clave, numero, nombre, proyecto, descripcion, estadoElemento, cardinalidad);
...
//-------------------------------------------------------------------
	...
	public static void pruebaRegistroEntidad() {
		...
		Entidad entidad = new Entidad(clave_Entidad, numero_Entidad, nombre_Entidad, proyecto, "Descripción de mi entidad.", estadoElemento);
		
		Atributo atributo = new Atributo(nombre_Atributo, entidad, "Nombre de pila", true, 20);
